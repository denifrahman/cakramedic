...
import 'package:cakramedic/screens/page_bottom_menu_management.dart';
...
class LoginPageManagement extends StatefulWidget {
//  static const routeName = '/login-screen';
  LoginPageManagement({Key key}) : super(key: key);
  final LocalStorage storage = new LocalStorage();

  @override
  _LoginPageManagementState createState() => new _LoginPageManagementState();
}

class _LoginPageManagementState extends State<LoginPageManagement>
...
//              .writeValue(key: 'session', value: response.body);
        ...
        Navigator.pushAndRemoveUntil(
            context,
            MaterialPageRoute(
                builder: (BuildContext context) => BottomMenuManagement()),
            ModalRoute.withName('/dashboard'));
        setState(() {
          _saving = false;
        });
