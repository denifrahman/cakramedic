...
class page_profile extends StatefulWidget {
  page_profile({Key key}) : super(key: key);

  @override
  _page_profileState createState() {
    return _page_profileState();
  }
}
...
//          backgroundColor: Colors.white,
          title: Row(
            ...
            children: <Widget>[
              Text('Profil Saya', style: TextStyle(fontSize: 20, letterSpacing: 0.1, fontWeight: FontWeight.w700),),
              InkWell(
                  onTap: () => _openSetting(),
        ...
        children: <Widget>[
          Expanded(
            ...
            child: InkWell(
              onTap: ()=>_openProfile(),
              child: ListTile(
                title: Text(inputNamaController.text, style: TextStyle( fontSize: 18),),
                trailing: Icon(Icons.mode_edit),
                subtitle: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Text(inputNoTelpController.text),
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                child: Align(
                    ...
                    child: Text('Keluar', style: TextStyle(fontSize:15,letterSpacing: 1, fontFamily: "WorkSansBold", fontWeight: FontWeight.w700, color: Colors.red),)),
              ),
            )
            )
        ],
