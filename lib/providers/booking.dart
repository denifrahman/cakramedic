...
//const baseUrl = "http://localhost/api-simrs-cakra/index.php/";
...
class Api {
  ...
  static Future bookingPendaftaranNonPasien(body) {
    var url = baseUrl + "/Booking/addNonPasien";
    return http.post(url, body: body);
  }
  ...
  static Future getBookingNonPasienByNoKtp(tanggal_booking, no_ktp) {
    var url = baseUrl + "/Booking/get_booking_non_pasien/" + tanggal_booking + "/" + no_ktp;
    return http.get(url);
  }
...
//    print(url);
  ...
  static Future getKunjunganPerTangganAndInstalasi(fromDate, toDate) {
    var url = baseUrl + "Dashboard/get_kunjungan_per_instalasi_dan_tanggal/" + fromDate + '/' + toDate;
//    print(url);
    return http.get(url);
  }
...
//    print(url);
  ...
  static Future getLoketAntrian() {
    var url = baseUrl + "Antrian/get_loket_antrian/";
    print(url);
    return http.get(url);
  }
